...
module.exports = {
	...
	saveActivity : async function(req,res){
		...
		const mailTeacher = {
		  ...
		  subject: 'Review Activity ' + sentActivity.title, // Subject line
		  html : `<div class="message-body has-text-black" style="color:#111;font-family: BlinkMacSystemFont,-apple-system,Segoe UI,Roboto,Oxygen,Ubuntu,Cantarell,Fira Sans,Droid Sans,Helvetica Neue,Helvetica,Arial,sans-serif;line-height:1.5;padding-top:20px;padding-right: 24px;padding-bottom:20px;padding-left:24px">
